...
Route::middleware('auth')->group(function () {
    ...
    Route::livewire('profile', 'pages::auth.profile')
        ->name('profile');

    Route::livewire('change-password', 'pages::auth.change-password')
        ->name('change.password');
});

Route::middleware(['auth', 'verified'])->group(function () {
    Route::livewire('email-verified', 'pages::auth.email-verified')
